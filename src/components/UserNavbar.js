...
const UserNavbar = () => {
    ...
    return (
        ...
        <div className="navbar bg-white fixed top-0 left-0 right-0 z-[1000] shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
